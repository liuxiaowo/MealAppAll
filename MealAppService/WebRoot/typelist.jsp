...
function search100() {
	if ($("#txtkeyword").val() == "") {
		location.href = "/MealAppService/servlet/GridServlet?Action=gettypelist&currentpage=0";
	} else {
         location.href = "/MealAppService/servlet/GridServlet?Action=gettypelist&currentpage=0"+ "&msg="
...
<table class="SearchTable" border="0" cellspacing="0"
						...
						<tr>
							...
							<td>
								<input type="button" class="btnClass_79px_A" value="添加"
									onclick="javascript:location.href='/MealAppService/typeinfo.jsp'" />
						...
						<tr>
							...
							<td>
							   <input id='Button2' title="修改" type="button" value=""
										class="btnGrid"
										onclick="javascript:location.href='/MealAppService/typeinfo.jsp?id=${data.id}'"
				...
				<div style="margin-top: 5px;">
					<a href="servlet/GridServlet?Action=gettypelist&currentpage=${1}">首页</a>
					<a
						href="servlet/GridServlet?Action=gettypelist&currentpage=${currentpage-1}">上一页</a>
					<a
						href="servlet/GridServlet?Action=gettypelist&currentpage=${currentpage+1}">下一页</a>
					<a
						href="servlet/GridServlet?Action=gettypelist&currentpage=${pagecount}">尾页</a>
