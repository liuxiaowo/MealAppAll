...
function search100() {
	if ($("#txtkeyword").val() == "") {
		location.href = "/MealAppService/servlet/GridServlet?Action=getdeliverymanlist&currentpage=0";
	} else {
         location.href = "/MealAppService/servlet/GridServlet?Action=getdeliverymanlist&currentpage=0"+ "&msg="
...
<table class="SearchTable" border="0" cellspacing="0"
				...
				<div style="margin-top: 5px;">
					<a href="servlet/GridServlet?Action=getdeliverymanlist&currentpage=${1}">首页</a>
					<a
						href="servlet/GridServlet?Action=getdeliverymanlist&currentpage=${currentpage-1}">上一页</a>
					<a
						href="servlet/GridServlet?Action=getdeliverymanlist&currentpage=${currentpage+1}">下一页</a>
					<a
						href="servlet/GridServlet?Action=getdeliverymanlist&currentpage=${pagecount}">尾页</a>
