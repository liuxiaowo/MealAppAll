...
function search100() {
	if ($("#txtkeyword").val() == "") {
		location.href = "/MealAppService/servlet/GridServlet?Action=getorderlist&currentpage=0";
	} else {
         location.href = "/MealAppService/servlet/GridServlet?Action=getorderlist&currentpage=0"+ "&msg="
...
<table class="SearchTable" border="0" cellspacing="0"
				...
				<table width="940px;" class="GridTable" border="0" cellspacing="0"
					...
					<c:forEach var="data" items="${datalist}">
						<tr>
							...
							<td><a href='javascript:void(0);' style="text-decoration: underline;" onclick='javascript:orderdetail(${data.id});'>详情</a></td>
				...
				<div style="margin-top: 5px;">
					<a href="servlet/GridServlet?Action=getorderlist&currentpage=${1}">首页</a>
					<a
						href="servlet/GridServlet?Action=getorderlist&currentpage=${currentpage-1}">上一页</a>
					<a
						href="servlet/GridServlet?Action=getorderlist&currentpage=${currentpage+1}">下一页</a>
					<a
						href="servlet/GridServlet?Action=getorderlist&currentpage=${pagecount}">尾页</a>
